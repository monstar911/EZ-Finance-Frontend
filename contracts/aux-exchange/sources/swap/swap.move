...
module auxexchange::swap {
    ...
    use auxexchange::u256;

    friend auxexchange::router;

    const ZERO_ACCOUNT: address = @zero_aux;
    const DEFAULT_ADMIN: address = @default_admin_aux;
    const RESOURCE_ACCOUNT: address = @auxexchange;
    const DEV: address = @dev_aux;
    ...
    */
    ...
    public(friend) fun create_pair<X, Y>(
        ...
        let lp_name: string::String = string::utf8(b"Aux-");
