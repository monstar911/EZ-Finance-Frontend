...
export const BACKEND_TOKEN_PRICE = "https://ez-finance-backend.vercel.app/api/prices";
export const BACKEND_VOLUME_DATA = "https://ez-finance-backend.vercel.app/api/dexes";

// export const BACKEND_TOKEN_PRICE = "http://localhost:4000/api/prices";
// export const BACKEND_VOLUME_DATA = "http://localhost:4000/api/dexes";
